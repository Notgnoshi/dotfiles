...
vim.keymap.set("i", "<C-p>", [[<C-r><C-o>=system('clip --paste')<cr>]], { silent = true })
...
vim.keymap.set("v", "<C-p>", [[:<C-u>let @c=system('clip --paste')<cr>gv"cP]], { silent = true })
vim.keymap.set("n", "<C-p>", [[:let @c=system('clip --paste')<cr>"cP]], { silent = true })
